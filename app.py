...
initial_result = minimize(minimize_function, initial_guess, args=(risk_aversion, extended_returns, extended_cov_matrix), method='SLSQP', bounds=[(0, 1)] * len(extended_returns), constraints=constraints)
...
for level, ra in risk_levels.items():
    result = minimize(minimize_function, initial_guess, args=(ra, extended_returns, extended_cov_matrix), method='SLSQP', bounds=[(0, 1)] * len(extended_returns), constraints=constraints)
    if result.success:
